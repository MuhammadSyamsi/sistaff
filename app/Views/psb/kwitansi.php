...
<body>
    <div class="wrap">
        <div class="user_icon"><a href="./mutasi"><img src="images/user.png" alt="" border="0" /></a></div>
        ...
        <div class="welcome_block">
            ...
            <div style="font-size:18px;color: #000; padding-top: 10px;">
                ...
                <p>Alhamdulillah amanah dari Bapak/ Ibu calon walisantri dari <b><?= $data['nama']; ?></b>, jenjang <?= $datsan['jenjang']; ?> sudah kami terima pada <b><?php echo date('d F Y', strtotime($data['tanggal'])); ?></b> sebagai berikut :</p>
                <br />
                ...
                <div style="margin-left: 50px;">
                    <?php if ($datsan['tdu'] < 0) : $datsan['tdu'] = 0;
                    endif ?>
                    <p>Daftar Ulang : <b><?= format_rupiah($datsan['tdu']); ?></b></p>
                </div>
            </div>
        </div>
